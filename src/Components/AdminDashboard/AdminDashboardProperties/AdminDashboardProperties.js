...
import AdminDashboardPropertiesTable from "./AdminDashboardPropertiesTable";
    ...
    <div className="px-5 mx-auto sm:px-8">
      <div className="py-8">
        <div className="flex flex-row justify-between w-full mb-1 sm:mb-0">
          <h2 className="text-2xl leading-tight font-medium">Properties</h2>
            ...
            <table className="min-w-full leading-normal">
              ...
              <tbody>
                {properties.map((property) => (
                  <AdminDashboardPropertiesTable property={property} />
                ))}
              </tbody>
            </table>
          </div>
